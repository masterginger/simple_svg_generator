...
def sun() -> Element:
    paths = [
        ...
        generate_svg_element(
            '<path d="m24 13c0 6.075-5.149 11-11.5 11-6.3513 0-11.5-4.925-11.5-11 0-6.0751 5.1487-11 11.5-11 6.351 0 11.5 4.9249 11.5 11z" transform="matrix(.78261 0 0 .81818 2.2174 1029.7)" fill="#f1c40f"/>'
        ),
    ]
